package expansion.world.blocks.distribution;
    ...
    public class DirectionalCoreUnloaderBuild extends DirectionalUnloaderBuild{
        ...
        public void updateTile(){
            if((unloadTimer += edelta()) >= speed){
                ...
                if(front != null && back != null && back.items != null && front.team == team && back.team == team && back.canUnload() && ((back instanceof CoreBlock.CoreBuild || (back instanceof StorageBlock.StorageBuild sb && sb.linkedCore != null)))){
                    if(unloadItem == null){
